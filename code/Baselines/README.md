# SemEval2021-Reading-Comprehension-of-Abstract-Meaning
 This is the repository for SemEval 2021 Task 4: Reading Comprehension of Abstract Meaning. It includes code for baseline models and data. The model output is in Cache folder.  
 To run the python script in your local computer, you should download the word embedding from the GloVe webpage: https://nlp.stanford.edu/projects/glove/ and replace **Data/embedding/glove.840B.300d/glove.840B.300d.txt** with it.  
 Also, change the **model_filename** in **Run_GAReader.py** to the according .pt file in **Cache/outputGAReader**.
## Data
**Data Format**
